...
> 私有本地总报告。更新至 2026-06-05。这个页面是顶部主入口，用来承载当前最完整的组织情报判断；每日扫描用于补充证据、反证和日期溯源。
...
| 正在变化 | Agent / coding infra / governance runtime / 行业 solution team 等新型组织单元是否成型 | DeepSeek、NVIDIA、Mistral、国内模型公司 | 招聘、官方产品栈、并购与生态伙伴线索，组织边界逐渐清晰但仍待长期验证 |
...
|---|---|---|---|---|---|
| 腾讯 | 正在变化 | AI Lab 调整并入大模型/混元相关组织；腾讯云成立云产品六部，负责 CodeBuddy / WorkBuddy；WorkBuddy 国际版进入正式全球发布路径；项目负责制线索 | AI 研发从实验室形态向模型产品线、平台化和交付节奏靠拢；agentic product 已开始进入专门 owner 结构，但基层管理权责是否改变仍待核验 | B/C | [2026-05-26](../daily-log/2026-05-26.html)、[2026-05-27](../daily-log/2026-05-27.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-04](../daily-log/2026-06-04.html)、[2026-06-05](../daily-log/2026-06-05.html) |
...
| Meta | 正在变化 | AI-focused 转岗、7,000 人转入 AI initiatives、managerial role elimination、裁员与管理层压缩叙事 | AI 优先级正在进入人力配置与 AI workflow 重组；正式机制出现更多公开细节，但效率结果仍待验证 | B | [2026-05-26](../daily-log/2026-05-26.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-04](../daily-log/2026-06-04.html) |
...
| 公司 | 状态 | 当前强信号 | 机制判断 | 证据等级 | 日期溯源 |
|---|---|---|---|---|---|
| OpenAI | 有定论 | Deployment Company、FDE、Codex Labs、AWS path、结构治理 | 交付能力组织化；workflow redesign、治理、资本与企业 rollout 已被放进同一组织边界 | A/L3 | [2026-05-27](../daily-log/2026-05-27.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-05](../daily-log/2026-06-05.html) |
| Anthropic | 有定论 | Labs / Product 拆分、RSP 版本化、安全门槛、Applied AI / FDE 岗位簇、Partner Network | 探索、规模化、安全治理、伙伴交付与企业 enablement 分属不同节奏与门槛，并继续制度化 | A/L3 | [2026-05-27](../daily-log/2026-05-27.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-06-03](../daily-log/2026-06-03.html)、[2026-06-05](../daily-log/2026-06-05.html) |
...
OpenAI 和 Anthropic 给出的信号最清晰，MiniMax 与 Mistral 则补出了另外两种组织化路径。

OpenAI 把 Deployment Company 和 Codex Labs 推出来，说明 Delivery / FDE 不只是销售支持，而可能成为模型公司连接客户流程、产品反馈和安全落地的组织能力。
...
- 状态：正在变化。
- 当前强信号：AI Lab 调整并入大模型/混元相关组织；腾讯云成立云产品六部负责 CodeBuddy / WorkBuddy；项目负责制、弱化组长制线索。
...
- 机制判断：研究议程、模型产品线、agentic product 与业务交付节奏可能被重新对齐；腾讯云侧已经出现更清晰的产品 owner 单元化。
- 组织影响：若预算、人事、绩效评价同步变化，决策速度和商业化聚焦度可能提升；若只是汇报线或品牌调整，机制变化有限。
- 追踪问题：项目负责人是否真正拥有目标权、资源权、评价权和奖金影响权？云产品六部是否拥有独立预算与人事影响权？混元是否承担更明确的对外交付/业务集成责任？
- 溯源：[2026-05-26](../daily-log/2026-05-26.html)、[2026-05-27](../daily-log/2026-05-27.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-04](../daily-log/2026-06-04.html)
...
- 状态：有定论。
- 当前强信号：Deployment Company、FDE、Codex Labs、AWS path、结构治理。
...
- 机制判断：模型公司正在把交付、流程改造、安全落地和客户生产系统部署组织化，并把 rollout / enablement 做成正式中间层。
- 组织影响：Research / Product / Applied / Safety / Delivery 的边界会更显性；交付组织成为模型公司效率系统的一部分。
- 反向解释：这也可能是商业化和收入确定性需求，不等于组织效率已被验证。
- 溯源：[2026-05-27](../daily-log/2026-05-27.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-05](../daily-log/2026-06-05.html)

### 4.5 Anthropic

- 状态：有定论。
- 当前强信号：Labs / Product 分工、RSP 版本化、安全门槛公开、Partner Network、Applied AI / FDE 岗位簇。
...
- 机制判断：探索、规模化、安全治理和伙伴交付不再靠同一组织节奏解决，而是拆成不同 motion。
- 组织影响：有助于降低“创新速度”和“发布安全”之间的临时协调成本；风险是接口治理不清。
- 溯源：[2026-05-27](../daily-log/2026-05-27.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-06-05](../daily-log/2026-06-05.html)
...
- 状态：正在变化。
- 当前强信号：AI-focused 转岗、7,000 人转入 AI initiatives、managerial role elimination、裁员与管理层压缩叙事。
...
- 机制判断：AI 优先级不再只是资源倾斜，而是在进入人力配置、管理跨度和组织动员机制；任务流正尝试围绕 AI workflows 重排。
- 组织影响：可能提升战略执行速度和资源集中度；也可能增加组织震荡、留任风险、隐私争议和职责不清。
- 追踪问题：AAI / ATA / Central Analytics 是否会形成稳定岗位族群？是否会出现绩效、晋升、RACI、管理跨度变化的进一步公开证据？
- 溯源：[2026-05-26](../daily-log/2026-05-26.html)、[2026-05-28](../daily-log/2026-05-28.html)、[2026-05-29](../daily-log/2026-05-29.html)、[2026-06-04](../daily-log/2026-06-04.html)、[2026-06-05](../daily-log/2026-06-05.html)
...
- 可进入公开知识库：OpenAI Deployment Company / Codex Labs、Anthropic Labs / Product、Anthropic RSP、Anthropic Partner Network、MiniMax Agent Team、Mistral Emmi AI / physics AI、GitLab 晋升流程、Shopify AI baseline、百度数字职级公开媒体线索。
