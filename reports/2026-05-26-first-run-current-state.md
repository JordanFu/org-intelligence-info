...
| Amazon | AI-native engineering | team-level velocity 目标 | AI 使用被报道进入绩效/晋升讨论 | 指标异化、刷 token |
...
**可迁移启发**：AI 绩效不能只看 token、次数、工具打开率。更好的指标是：
...
- Salesforce Axios：https://www.axios.com/2026/04/15/tokenmaxxing-ai-roi-metrics
